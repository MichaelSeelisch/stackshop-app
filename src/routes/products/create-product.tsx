...
import { badgeEnum, BadgeValue, inventoryEnum, InventoryValue, ProductInsert, ProductSelect } from '@/db/schema';
...
const createProductServerFn = createServerFn({
	...
	.inputValidator((data: CreateProductData) => {
		return (
			data
		);
	})
						...
						>
							...
							<form.Field name='badge'>
								{( field ) => {
									return (
										<div className='space-y-2'>
											<Label htmlFor='{field.name}'>IBadge (optional)</Label>
