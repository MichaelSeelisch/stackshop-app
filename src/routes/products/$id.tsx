...
export const Route = createFileRoute('/products/$id')({
	...
	// loader: async ({ params }) => {
	// 	return (
	// 		sampleProducts.find(product => product.id === params.id)
	// 	);
	// }
	loader: async ({ params }) => {
				...
				<Card className='max-w-4xl mx-auto !p-4'>
					<div className='grid gap-6 md:grid-cols-2'>
						<div className='space-y-4'>
							<div className='spect-4/3 overflow-hidden rounded-xl border bg-linear-to-br from-slate-50 via-white to-slate-100 dark:from-slate-800 dark:to-slate-900'>
								<img
									src={product.image}
									alt={product.name}
